...
<body id="body">	
	<div class="header header_blue">
		<div class="auto">
			...
			<p class="left course_tit"><a onclick="javascript:history.go(-1)"><img src="../images/jiantou_03.png"></a>${course.name}</p>
			<div class="right login_area">
				...
				<div class="user_head right ">
					...
					<p class="logout" onclick="javascript:document.location.href='/XMS_Code_SSM_V1/login/loginOut.do'">${user.nickname}&nbsp;&nbsp;&nbsp; 注销登录</p>
				</div>
			</div>
		</div>
	</div>
